...
public:
    ...
    void insert(std::size_t start_index, std::size_t count_elements, T default_element) {
        std::size_t old_size = _size;
...
void stupid_sort(MyVector<int>& vec, std::size_t vector_size) {
    int n,i,j;
...
void quicksort(MyVector<int>& vector, int left, int right) {
...
void test_stupid_sort(int n) {
    ...
    stupid_sort(vec_ideal, n);
    auto end = std::chrono::steady_clock::now();
    auto time_ideal = std::chrono::duration_cast<std::chrono::microseconds>(end - begin);

    begin = std::chrono::steady_clock::now();
    stupid_sort(vec_random, n);
    end = std::chrono::steady_clock::now();
    auto time_random = std::chrono::duration_cast<std::chrono::microseconds>(end - begin);

    begin = std::chrono::steady_clock::now();
    stupid_sort(vec_recursive, n);
    end = std::chrono::steady_clock::now();
    auto time_recursive = std::chrono::duration_cast<std::chrono::microseconds>(end - begin);

    std::cout << "Stupid sort ideal (count elements " << n << ") " << time_ideal.count() << std::endl;
    std::cout << "Stupid sort recursive (count elements " << n << ") " << time_recursive.count() << std::endl;
    std::cout << "Stupid sort random (count elements " << n << ") " << time_random.count() << std::endl;
    std::cout << std::endl;
    
}
void test_quicksort(int n) {
    MyVector<int> vec_ideal;
    MyVector<int> vec_random;
    MyVector<int> vec_recursive;
    ...
    begin = std::chrono::steady_clock::now();
    quicksort(vec_random,0, n-1);
    end = std::chrono::steady_clock::now();
    auto time_random = std::chrono::duration_cast<std::chrono::microseconds>(end - begin);

    begin = std::chrono::steady_clock::now();
    quicksort(vec_recursive,0, n-1);
    end = std::chrono::steady_clock::now();
    auto time_recursive = std::chrono::duration_cast<std::chrono::microseconds>(end - begin);

    std::cout << "Quick sort ideal (count elements " << n << ") " << time_ideal.count() << std::endl;
    std::cout << "Quick sort recursive (count elements " << n << ") " << time_recursive.count() << std::endl;
    std::cout << "Quick sort random (count elements " << n << ") " << time_random.count() << std::endl;
    std::cout << std::endl;
...
int main() {
    ...
    test_stupid_sort(100);
    test_stupid_sort(1000);
    test_stupid_sort(10000);
